...
export default function PermissionsScreen() {
  ...
  // const { devices } = useCameraDevices(); // Get available camera devices
  const backCamera = devices.find((device) => device.position === "back"); // Find the back camera

  // Check if the back camera is available
  const isBackCameraAvailable = backCamera ? true : false;
  ...
  return (
    <>
      ...
      <ThemedView style={styles.container}>
        ...
        <ThemedText type="subtitle" style={styles.subtitle}>
          Snappy needs access to a few permissions in order to work properly.
        </ThemedText>
        ...
        {/* Display if the back camera is available */}
        <ThemedText type="subtitle" style={styles.subtitle}>
